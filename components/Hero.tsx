      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-5">
          <a 
            ...
            className="group relative px-8 py-4 bg-zinc-900 dark:bg-zinc-100 text-zinc-100 dark:text-zinc-900 font-bold rounded-2xl transition-all hover:scale-[1.02] active:scale-[0.98] shadow-xl flex items-center gap-3"
          >
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="group px-8 py-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 font-bold rounded-2xl hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all hover:border-zinc-300 dark:hover:border-zinc-500 shadow-lg flex items-center gap-3"
          >
            <svg className="w-5 h-5 fill-zinc-900 dark:fill-zinc-100 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
